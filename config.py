...
API_ID = int(os.environ.get("API_ID", "25754552"))
API_HASH = os.environ.get("API_HASH", "277125b1c0e6a3c547bd653dbb624f2")
BOT_TOKEN = os.environ.get("BOT_TOKEN", "5416599017:AAFoElaFVb76D4WZPXidWmsn_PzquBMZJ7w")
DROPLINK_API = os.environ.get("DROPLINK_API")
MDISK_API = os.environ.get("MDISK_API", "XWGmoGVxD546y4ga6mk6")
ADMINS = list(int(i.strip()) for i in os.environ.get("ADMINS").split("5387726277")) if os.environ.get("ADMINS") else []
DATABASE_NAME = os.environ.get("DATABASE_NAME", "MdiskConvertorBotprogk")
DATABASE_URL = os.environ.get("DATABASE_URL", "mongodb+srv://dankomemehindi:<password>@cluster0.bmuzx8q.mongodb.net/?retryWrites=true&w=majority")
...
CHANNEL_ID = list(int(i.strip()) for i in os.environ.get("CHANNEL_ID").split("-1001828914649")) if os.environ.get("CHANNEL_ID") else []
